...
type Props = {
    id: string;
    name: string;
    imagelink_square: keyof typeof images;
            ...
            {prices.length != 1 ? (
                <LinearGradient
                    ...
                    <View style={styles.cartItemRow}>
                        <Image source={images[imagelink_square]} style={styles.cartItemImage} />
                ...
                <LinearGradient
                    ...
                    <View>
                        <Image
                            source={images[imagelink_square]}
                            // source={require('../assets/coffee_assets/macchiato/square/macchiato_pic_3_square.png')}
